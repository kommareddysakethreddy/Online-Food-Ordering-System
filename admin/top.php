...
}elseif($cur_path=='admin.php' || $cur_path=='manage_admin.php'){
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
        ...
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.php"><img src="assets/images/vieat.png" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="index.php"><img src="assets/images/vieat.png" alt="logo"/></a>
        </div>
        ...
        <ul class="nav">
		  ...
		  <li class="nav-item">
            <a class="nav-link" href="order.php">
              <i class="mdi mdi-food-croissant menu-icon"></i>
