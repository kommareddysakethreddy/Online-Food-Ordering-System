...
if(isset($_POST['submit'])){
    ...
    $rand = rand(1, 1000000);
    $new_password=password_hash($rand,PASSWORD_BCRYPT);	
	mysqli_query($con,"update user set password='$new_password' where email='$email'");
    $html=forgot($rand);
    send_email($email,$html,'VIEAT: Your New Password!');
}
?>
                                        ...
                                        <div class="login-register-form">
                                            <form method="post">
                                                ...
                                                <div class="button-box">
                                                    ...
                                                    <button type="submit" id="forgot_submit" name="submit">Receive new password via email</button>
