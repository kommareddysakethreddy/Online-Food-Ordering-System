                                    ...
                                    <div class="login-form-container">
                                        <div class="login-register-form">
                                            <form method="post" id="frmRegister">
                                                ...
                                                <input type="textbox" name="address" placeholder="Address" id="address" required>
                                                <div class="button-box">
                                                    <button type="submit" id="register_submit">Register</button>
                                                </div>
                                                &nbsp;
                                                <p style="color:red">Once you click on register, Please verify your Email ID after the "please wait" message disappears</p>
