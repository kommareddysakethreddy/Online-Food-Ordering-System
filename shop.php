                ...
                <div class="row flex-row-reverse">
                    <div class="col-lg-9">
                        ...
                        <?php
							...
							if($search_str!=''){		
                                $product_sql.=" and (dish like '%$search_str%') ";
                            }
                                            ...
                                            <div class="product-wrapper">
                                                <div class="product-img">
                                                    <a href="javascript:void(0)">
                                                        <img src="<?php echo SITE_DISH_IMAGE.$product_row['image']?>" height=250 alt="">
                                                    </a>
                                                </div>
                                                <div class="product-content" id="dish_detail">
                                                    <h4>
														...
														<a href="javascript:void(0)"><?php echo ucfirst($product_row['dish']);
													...
													<?php
													$dish_attr_res=mysqli_query($con,"select * from dish where status='1' and id='".$product_row['id']."' order by price asc");
													?>
                                                    <div class="product-price-wrapper">
                                                        <?php
														$dish_attr_row=mysqli_fetch_assoc($dish_attr_res);
